  ...
  public: {
    Tables: {
      amistades: {
        ...
        Relationships: [
          {
            foreignKeyName: "amistades_amigo_id_fkey"
            columns: ["amigo_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "amistades_usuario_id_fkey"
            columns: ["usuario_id"]
            isOneToOne: false
            referencedRelation: "usuarios"
            referencedColumns: ["id"]
      ...
      future_reminder_files: {
        Row: {
          created_at: string
          future_reminder_id: string
          id: string
          recuerdo_id: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "future_reminder_files_future_reminder_id_fkey"
            columns: ["future_reminder_id"]
            isOneToOne: false
            referencedRelation: "future_reminders"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "future_reminder_files_recuerdo_id_fkey"
            columns: ["recuerdo_id"]
            isOneToOne: false
            referencedRelation: "recuerdos"
            referencedColumns: ["id"]
      ...
      future_reminders: {
        Row: {
          ...
          due_notification_sent_at: string | null
          id: string
          last_reminder_sent_at: string | null
          message: string | null
          opened_at: string | null
          pre_due_notification_sent_at: string | null
      ...
      mejoras_ia_log: {
        Row: {
          ...
          tipo: string
          url_antes: string | null
          url_despues: string | null
          usuario_id: string | null
        }
        Insert: {
          fecha?: string
        ...
        Relationships: [
          {
            foreignKeyName: "mejoras_ia_log_recuerdo_id_fkey"
            columns: ["recuerdo_id"]
            isOneToOne: false
            referencedRelation: "recuerdos"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "mejoras_ia_log_usuario_id_fkey"
            columns: ["usuario_id"]
            isOneToOne: false
            referencedRelation: "usuarios"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      admin_dashboard_usuarios_suscripciones: {
        Args: Record<PropertyKey, never>
        Returns: {
          id: string
          nombre: string
      ...
      hide_contributor_capsule: {
        Args: { p_capsule_id: string }
        Returns: undefined
      }
      is_capsule_contributor: {
        Args: { capsule_id_to_check: string; user_id_to_check: string }
        Returns: boolean
      }
      is_capsule_owner: {
        Args: { capsule_id_to_check: string; user_id_to_check: string }
      ...
      toggle_recuerdo_favorito: {
        Args: { p_recuerdo_id: string }
        Returns: undefined
      }
      unlockrows: {
        Args: { "": string }
    ...
    Enums: {
      ...
      reminder_status: "scheduled" | "available" | "failed" | "cancelled"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
